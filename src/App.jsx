...
// 사업단계 그룹 (필터용) - 법적 절차 순서 (주택법 제11조·제15조·제66조·제68조·제76조 기준)
...
const FLOW_STEPS = [
  ...
  },
  {
    ...
    duration: "6개월~1년",
    law: "주택법 제11조 ③ · 시행령 제20조 (전체 구분소유자 2/3 이상 + 각 동 과반수 동의)",
    tasks: [
  ...
  },
  {
    ...
    duration: "1년 내외",
    law: "건축법 · 국토의 계획 및 이용에 관한 법률 · 도시교통정비 촉진법 등",
    tasks: [
      "건축위원회 심의 (서울시·성남시 등)",
      "경관위원회 심의",
  ...
  },
  {
    ...
    duration: "3~5년",
    law: "주택법 제49조 (사용검사 등) · 제66조 ⑦ (리모델링 사용검사)",
    tasks: [
      "착공 신고 · 본 공사 착공",
      "수평 / 별동 / 수직 증축 공사",
      "시설 공사 · 내·외장 공사",
    ...
    <div className="flow-modal-backdrop" onClick={onClose}>
      <div className="flow-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flow-footer">
          <strong>총 소요기간:</strong> 약 8~12년 · <strong>근거 법령:</strong> 주택법 제66조 (리모델링의 허가 등)
        </div>
      </div>
    </div>
  );
